    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 gap-8">
        <div class="space-y-4">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">A108 Adam Street, New York, NY 535022</p>
            </div>
          </div>
          <div class="flex items-start gap-4">
            <i class="bi bi-telephone text-2xl text-blue-600"></i>
            <div>
        ...
        <form @submit.prevent class="space-y-4">
          ...
          <input type="text" placeholder="Subject" class="w-full p-3 border rounded" required />
          <textarea rows="6" placeholder="Message" class="w-full p-3 border rounded" required></textarea>
...
<script setup>
// Static form - no back-end handling yet
</script>
